...
namespace DoTheRightThing\WPDTRT_Plugin_Boilerplate\r_1_5_11;
...
if ( ! class_exists( 'Plugin' ) ) {
	...
	class Plugin {
		...
		const WPDTRT_PLUGIN_VERSION = '1.5.11';

		/**
		 * Initialise the object's properties when it is instantiated.
		 * This is a protected method as every plugin uses a sub class:
		 * class WPDTRT_Test_Plugin extends DoTheRightThing\WPDTRT_Plugin_Boilerplate\r_1_5_11\Plugin {...}
		 *
