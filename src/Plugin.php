...
namespace DoTheRightThing\WPDTRT_Plugin_Boilerplate\r_1_6_4;
...
if ( ! class_exists( 'Plugin' ) ) {
	...
	class Plugin {
		...
		const WPDTRT_PLUGIN_VERSION = '1.6.4';
		 ...
		 * --- php
		 * class WPDTRT_Test_Plugin extends DoTheRightThing\WPDTRT_Plugin_Boilerplate\r_1_6_4\Plugin {...}
		 * ---
		 *
