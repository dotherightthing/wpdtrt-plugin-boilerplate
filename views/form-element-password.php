...
<?php echo $field_start; // phpcs:ignore ?>
	<input type="password" name="<?php echo esc_attr( $name ); // phpcs:ignore ?>" id="<?php echo esc_attr( $id ); // phpcs:ignore ?>" value="<?php echo esc_attr( $value ); // phpcs:ignore ?>" size="<?php echo esc_attr( $size ); // phpcs:ignore ?>" class="<?php echo esc_attr( $classname ); // phpcs:ignore ?>" aria-describedby="<?php echo esc_attr( $id ); // phpcs:ignore ?>-tip">
